	...
	render: function () {
		...
		if(Parse.User.current())
		{
			return(
					<div id="header">
						<div id="navigation">
							<a href={"/" + this.props.curruser.username}><h5 id="font_logo">JAMKNIFE</h5></a>
							...
							<div id="user_nav">
								<img className="avatar" src={this.props.curruser.photo? this.props.curruser.photo.url() : "public_folder/images/Edit Profile/default_picture.png"}/>
				...
				return(
					<div id="profile_section">
						...
						<div id="avatar_container">
							<img className="avatar" src={this.props.curruser.photo? this.props.curruser.photo.url() : "public_folder/images/Edit Profile/default_picture.png"} onerror="this.src = 'public_folder/images/Edit Profile/default_picture.png';"/>
						</div> 
						<div id="profile_container">
							...
							<h2 className="full_name">{this.props.curruser.fullname}</h2>
	...
	render: function () {
		...
		return(
			...
			{this.data.posts.map(function(post) {
				return (
					<li name={post.objectId} className="thumbnail" key={post.objectId} onClick={this.alerttileDisplay.bind(this, post.objectId)}>
